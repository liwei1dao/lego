...
type ServiceNode struct {
	...
	Meta    map[string]string `protobuf:"bytes,6,rep,name=meta,proto3" json:"meta" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` //元数据
}
...
func (x *ServiceNode) GetMeta() map[string]string {
	if x != nil {
		return x.Meta
	}
	return nil
...
var file_proto_proto_rawDesc = []byte{
	0x0a, 0x0b, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd6, 0x01,
	...
	0x72, 0x12, 0x2a, 0x0a, 0x04, 0x6d, 0x65, 0x74, 0x61, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x16, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x4e, 0x6f, 0x64, 0x65, 0x2e, 0x4d, 0x65,
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x08, 0x5a, 0x06, 0x2e, 0x3b, 0x63, 0x6f, 0x72, 0x65,
...
var file_proto_proto_goTypes = []interface{}{
	...
	nil,                 // 1: ServiceNode.MetaEntry
}
var file_proto_proto_depIdxs = []int32{
	1, // 0: ServiceNode.meta:type_name -> ServiceNode.MetaEntry
