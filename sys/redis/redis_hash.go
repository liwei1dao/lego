...
*/
func (this *Redis) HDel(key core.Redis_Key, fields ...string) (err error) {
...
*/
func (this *Redis) HExists(key core.Redis_Key, field string) (result bool, err error) {
...
*/
func (this *Redis) HGet(key core.Redis_Key, field string, value interface{}) (err error) {
...
*/
func (this *Redis) HGetAll(key core.Redis_Key, valuetype reflect.Type) (result []interface{}, err error) {
...
*/
func (this *Redis) HIncrBy(key core.Redis_Key, field string, value int) (err error) {
...
如果指定的字段不存在，那么在执行命令前，字段的值被初始化为 0
*/
func (this *Redis) HIncrByFloat(key core.Redis_Key, field string, value float32) (err error) {
...
*/
func (this *Redis) Hkeys(key core.Redis_Key) (result []string, err error) {
...
*/
func (this *Redis) Hlen(key core.Redis_Key) (result int, err error) {
...
*/
func (this *Redis) HMGet(key core.Redis_Key, valuetype reflect.Type, fields ...string) (result []interface{}, err error) {
	agrs := make([]interface{}, 0)
...
*/
func (this *Redis) HMSet(key core.Redis_Key, value map[string]interface{}) (err error) {
	agrs := make([]interface{}, 0)
...
*/
func (this *Redis) HSet(key core.Redis_Key, field string, value interface{}) (err error) {
...
*/
func (this *Redis) HSetNX(key core.Redis_Key, field string, value interface{}) (err error) {
	var resultvalue []byte
	if resultvalue, err = this.encode(value); err == nil {
