...
func (this *RedisPool) SetKeyForValue(key string, value interface{}) {
	if b, err := json.Marshal(value); err == nil {
		...
		if err != nil {
			log.Errorf("SetKey_String 设置缓存数据失败 key:%s err:%v", key, err)
		}
	}
}
...
func (this *RedisPool) GetExKeyForValue(key string, value interface{}, expire int) (err error) {
	...
	if err != nil {
		return fmt.Errorf("GetKey_String 获取缓存数据失败 key:%s err:%v", key, err)
	}
	err = json.Unmarshal([]byte(v), value)
	if err != nil {
		return fmt.Errorf("GetKey_String 解析缓存数据失败 key:%s Value:%s err:%v", key, v, err)
	}
	pool.Do("EXPIRE", key, expire)
	return nil
}
...
func (this *RedisPool) GetListCount(key string) (count int, err error) {
	...
	if err != nil {
		return count, fmt.Errorf("GetListCount 执行异常 key:%s err:%v", key, err)
	}
	return count, nil
}
...
func (this *RedisPool) GetListByLIndex(key string, index int32, value interface{}) (err error) {
	...
	if err != nil {
		return fmt.Errorf("GetListByLIndex 执行异常 key:%s index:%d err:%v", key, index, err)
	}
...
func (this *RedisPool) SetListByLPush(key string, value []interface{}) {
	...
	if err != nil {
		log.Errorf("SetKey_String 设置缓存列表数据失败 key:%s err:%v", key, err)
	}
}
...
func (this *RedisPool) GetListByLrange(key string, start, end int32, valuetype reflect.Type) (values []interface{}) {
	...
	values = make([]interface{}, 0)
	if err != nil {
		log.Errorf("GetListByLrange 执行异常 key:%s err:%v", key, err)
		return
	}
...
func (this *RedisPool) GetListByRPop(key string, value interface{}) (err error) {
	...
	if err != nil {
		return fmt.Errorf("GetListByRPop  key:%s err:%v", key, err)
	}
	err = json.Unmarshal([]byte(data), value)
	if err != nil {
		return fmt.Errorf("GetListByRPop  key:%s err:%v", key, err)
...
func (this *RedisPool) GetListByLPop(key string, value interface{}) (err error) {
	...
	if err != nil {
		return fmt.Errorf("GetListByLPop  key:%s err:%v", key, err)
	}
	err = json.Unmarshal([]byte(data), value)
	if err != nil {
		return fmt.Errorf("GetListByLPop  key:%s err:%v", key, err)
...
func (this *RedisPool) RemoveListByValue(key string, value interface{}) (err error) {
	...
	valueStr := ""
	if b, err := json.Marshal(value); err != nil {
		log.Errorf("RemoveListByValue  key:%s err:%v ", key, err)
		return err
	} else {
		valueStr = string(b)
	}
...
func (this *RedisPool) GetKey_Map(key string, valuetype reflect.Type) (Value map[string]interface{}) {
	...
	if err != nil {
		log.Errorf("SetKey_String 读取缓存哈希表数据失败 key:%s err:%v", key, err)
		return
	}
...
func (this *RedisPool) GetKey_MapByKey(key string, fieldkey string, value interface{}) (err error) {
	...
	if err != nil {
		return fmt.Errorf("GetKey_MapByKey 读取缓存哈希表数据失败 key:%s err:%v", key, err)
	}
	err = json.Unmarshal([]byte(movies), value)
	if err != nil {
		return fmt.Errorf("读取Redis Map【%s】【%s】err:%v", key, fieldkey, err)
	}
	return nil
}
...
func (this *RedisPool) Get_PatternKeys(_Patternkey string, valuetype reflect.Type) (Values []interface{}) {
	...
	if err != nil {
		log.Errorf("SetKey_String 读取缓存列表数据失败 key:%s err:%v", _Patternkey, err)
		return
	}
