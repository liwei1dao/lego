...
*/
func (this *Redis) Lindex(key core.Redis_Key, value interface{}) (err error) {
	var data string
...
*/
func (this *Redis) Linsert(key core.Redis_Key, isbefore bool, tager interface{}, value interface{}) (err error) {
	var (
		tagervalue  []byte
		resultvalue []byte
	)
...
*/
func (this *Redis) Llen(key core.Redis_Key) (result int, err error) {
...
*/
func (this *Redis) LPop(key core.Redis_Key, value interface{}) (err error) {
	var data string
...
*/
func (this *Redis) LPush(key core.Redis_Key, values ...interface{}) (err error) {
...
*/
func (this *Redis) LPushX(key core.Redis_Key, values ...interface{}) (err error) {
	agrs := make([]interface{}, 0)
...
*/
func (this *Redis) LRange(key core.Redis_Key, start, end int, valuetype reflect.Type) (result []interface{}, err error) {
	var _result []string
...
*/
func (this *Redis) LRem(key core.Redis_Key, count int, target interface{}) (err error) {
...
*/
func (this *Redis) LSet(key core.Redis_Key, index int, value interface{}) (err error) {
	var resultvalue []byte
	if resultvalue, err = this.encode(value); err == nil {
...
*/
func (this *Redis) Ltrim(key core.Redis_Key, start, stop int) (err error) {
...
*/
func (this *Redis) Rpop(key core.Redis_Key, value interface{}) (err error) {
	var data string
...
*/
func (this *Redis) RPopLPush(oldkey core.Redis_Key, newkey core.Redis_Key, value interface{}) (err error) {
	var data string
...
*/
func (this *Redis) RPush(key core.Redis_Key, values ...interface{}) (err error) {
	agrs := make([]interface{}, 0)
...
*/
func (this *Redis) RPushX(key core.Redis_Key, values ...interface{}) (err error) {
	agrs := make([]interface{}, 0)
