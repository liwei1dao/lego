...
type (
	ISys interface {
		TxtToVoice(ctx context.Context, srcText string, w io.Writer) (err error)
	}
)
...
func TxtToVoice(ctx context.Context, srcText string, w io.Writer) (err error) {
	return defsys.TxtToVoice(ctx, srcText, w)
}
