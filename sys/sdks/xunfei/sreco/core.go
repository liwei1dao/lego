...
type (
	ISys interface {
		VoiceToTxt(ctx context.Context, reader io.Reader) (result string, err error)
	}
)
...
func VoiceToTxt(ctx context.Context, reader io.Reader) (result string, err error) {
	return defsys.VoiceToTxt(ctx, reader)
}
