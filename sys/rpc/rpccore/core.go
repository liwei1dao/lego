...
type ISys interface {
	...
	ShakehandsRequest(ctx context.Context, client IConnClient) (err error) //rpc服务发起握手请求
}
...
type ISelector interface {
	...
	UpdateServer(servers map[string]core.IServiceNode) (add, del, change []core.IServiceNode)
}
