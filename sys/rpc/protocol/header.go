...
// 协议类型 请求/回应  10000000
func (this *Header) MessageType() rpc.MessageType {
	return rpc.MessageType(this[2]&0x80) >> 7
}

// 设置 协议类型 请求/回应
func (this *Header) SetMessageType(mt rpc.MessageType) {
...
// 读取压缩方式 00001110
func (this *Header) CompressType() rpc.CompressType {
	return rpc.CompressType((this[2] & 0x0E) >> 1)
}

// 设置压缩类型
func (this *Header) SetCompressType(ct rpc.CompressType) {
	this[2] = (this[2] &^ 0x0E) | ((byte(ct) << 1) & 0x0E)
}

// 消息状态
// 00000001
func (this *Header) MessageStatusType() rpc.MessageStatusType {
	return rpc.MessageStatusType(this[2] & 0x01)
}

// 设置消息状态 正常或者错误
func (this *Header) SetMessageStatusType(mt rpc.MessageStatusType) {
	this[2] = (this[2] &^ 0x01) | (byte(mt) & 0x01)
}

// SerializeType returns serialization type of payload.
func (this *Header) SerializeType() rpc.SerializeType {
	return rpc.SerializeType((this[3] & 0xF0) >> 4)
}

// SetSerializeType sets the serialization type.
func (this *Header) SetSerializeType(st rpc.SerializeType) {
