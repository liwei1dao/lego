...
func NewConsulDiscovery(basePath, servicePath string, consulAddr []string, options *Options) (*ConsulDiscovery, error) {
...
func NewConsulDiscoveryTemplate(basePath string, consulAddr []string, options *Options) (*ConsulDiscovery, error) {
	if basePath[0] == '/' {
		basePath = basePath[1:]
	}
