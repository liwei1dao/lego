...
type Options struct {
	...
	SerializeType     rpc.SerializeType //消息序列化方式 0:JSON 1:ProtoBuffer 2:MsgPack 3:Thrift
	CompressType      rpc.CompressType  //消息压缩模式	0:CompressNone 1:CompressGzip
